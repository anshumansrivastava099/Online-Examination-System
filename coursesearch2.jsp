...
<div class="form-group" style="padding-left: 127px;">
	<%	out.println("<a class=\"btn btn-warning\" href=\"courseentrypage2.jsp?Course_Code="+sc+"\" role=\"button\">");
  out.println("Update");
	  out.println("</a>");
	  %>
	
	  <a class="btn btn-warning ml-5" href="subjectsearchp.jsp" role="button">Subject</a>
