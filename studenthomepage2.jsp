...
<body>
	...
	<nav class="navbar navbar-expand-sm navbar-dark bg-dark fixed-top">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			...
			<a class="btn btn-primary" style="margin: 12px;" href="studenthomepage2.jsp" role="button">HOME</a>
			...
			<div class="btn-group" style="margin: 12px;">
				...
				<div class="dropdown-menu">
					<a class="dropdown-item" href="studentprofile2.jsp">Profile</a>
					<a class="dropdown-item" href="studentregpage.jsp">Complete Registration</a>
			...
			<div class="btn-group" style="margin: 12px;">
				...
				<div class="dropdown-menu">
					<a class="dropdown-item" href="stdcoursesearch.jsp">View Course</a>
				</div>
			</div>
			<div class="btn-group" style="margin: 12px;">
				<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown"
				...
				<div class="dropdown-menu">
					<a class="dropdown-item" href="stdquizviewpage.jsp">View Quiz</a>
					
					</div>
			</div>
			<a class="btn btn-primary" style="margin: 12px;" href="stdquizviewpageresult.jsp" role="button">RESULT</a>
			<div class="btn-group" style="margin: 12px;">
				<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown"
					aria-haspopup="true" aria-expanded="false">
					QUESTIONS BANK
				...
				<div class="dropdown-menu">
					<a class="dropdown-item" href="stdquestiondisplay.jsp">View Question</a>
					</div>
			</div>
			<div class="btn-group" style="margin: 12px;">
				<div class="btn-group" style="margin: 12px;">
	...
	<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			...
			<form action="http://localhost:8080/examples/schangepassword.jsp" method="GET">
