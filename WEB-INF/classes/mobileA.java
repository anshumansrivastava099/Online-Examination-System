...
public class mobileA extends HttpServlet
{
...
pw.println("<h2>");
pw.println("<form  action=\"http://localhost:8080/examples/freezeA\" method=\"GET\">");
...
pw.println("<br>");
pw.println("The Mobile which you select is:<input type=\"text\" name=\"t1\" value='"+s1+"'>");
pw.println("<br>");
