...
<div class="form-group" style="padding-left: 127px;">
	<%	out.println("<a class=\"btn btn-warning\" href=\"subjectupdatepage.jsp?Subject_Code="+sc+"\" role=\"button\">");
  out.println("Update");
	  out.println("</a>");
	  %>
	
	  <a class="btn btn-warning ml-5" href="unitsearchp.jsp" role="button">Units</a>
